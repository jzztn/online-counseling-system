			...
			<div className="bg-black bg-opacity-30 p-8 grid grid-rows-[auto,1fr,auto] gap-8 rounded-xl">
				...
				<div>
					<input
						...
						className="border-none outline-none w-full py-4 pl-3  rounded-md placeholder:text-opacity-20 placeholder:text-sm"
					/>

					<input
						type={"password"}
						placeholder="Password"
						className="mt-4 border-none outline-none w-full py-4 pl-3 rounded-md placeholder:text-opacity-20 placeholder:text-sm"
					/>
				</div>

				<Link href={'/users/students/home'}>
					<button className="bg-button py-4 text-white text-sm rounded-md tracking-wider hover:font-semibold transition-all duration-500">LOG IN</button>
				</Link>
