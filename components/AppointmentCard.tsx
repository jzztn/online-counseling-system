	...
	return (
		<div className="bg-gradient-to-b from-green-100 to-lightgreen grid grid-flow-rows gap-4 text-center p-10 rounded-lg">
			...
			<div className="flex flex-col gap-2">
				<h1 className="text-sm font-light mt-4 lg:mt-10">{sched}</h1>
				<h1 className="text-sm font-light">{sched2}</h1>
			</div>

			<button className="mt-8 py-5 bg-button rounded-sm text-white text-xs tracking-wide hover:font-semibold transition-colors duration-200"> SET APPOINTMENT</button>
		</div>
	)
}
