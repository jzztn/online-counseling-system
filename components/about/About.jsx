const About = () => {
	return (
		<div className="grid lg:grid-cols-[1fr,1fr] py-56 lg:py-72 px-20 justify-center items-center gap-20 text-center lg:gap-0">
			<div className="justify-center hidden lg:block">
				<img src="/about.png" alt="about" className="rounded-full h-full w-full" />
			</div>

			<div className="flex flex-col gap-8 justify-center text-left">
				<h1 className="text-3xl lg:text-5xl tracking-wider">ABOUT</h1>
