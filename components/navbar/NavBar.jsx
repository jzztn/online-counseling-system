...
const NavBar = () => {
	return (
		<div className=" grid grid-cols-[auto,1fr] items-center p-6 border-b-gray border-[1px] border-t-0 border-l-0 border-r-0">
			<div className="flex flex-row gap-4 items-center">
				<div>
					<img src="/logo.png" alt="cvsu logo" className="w-20 h-20" />
				</div>
			...
			<div className="group lg:hidden ml-auto">
				...
				<div className="absolute top-0 right-0 bg-button h-full w-72 hidden py-6 group-hover:block transition-all duration-700">
