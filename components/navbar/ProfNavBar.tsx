	...
	return (
		<div className="z-10 grid grid-cols-[auto,1fr] items-center p-6 border-b-gray border-[1px] border-t-0 border-l-0 border-r-0">
			...
			<div className="hidden ml-auto lg:flex gap-8 tracking-wide">
				<div className="group">
					<Link href={'/users/professors/profile'}><h1 className="relative cursor-pointer text-lg">Appointments</h1></Link>
					<div className="bg-button w-0 h-1 opacity-0 transition-all duration-500 group-hover:opacity-100 group-hover:w-full"></div>
				</div>

				<div className="group">
					<Link href={'/users/professors/chat'}><h1 className="cursor-pointer text-lg">Chat</h1></Link>
					<div className="bg-button w-0 h-1 opacity-0 transition-all duration-500 group-hover:opacity-100 group-hover:w-full"></div>
				</div>
			...
			<div className="group lg:hidden ml-auto">
				...
				<div className="absolute top-0 right-0 bg-button h-full w-64 hidden py-6 group-hover:block transition-all duration-700">
					<ul className="flex flex-col gap-12 text-center mt-20">
						<Link href={'/users/professors/profile'}><h1 className="text-lg text-white tracking-wide cursor-pointer hover:bg-white hover:bg-opacity-30 py-4 transition-all duration-500">Home</h1></Link>
						<Link href={'/users/professors/chat'}><h1 className="text-lg text-white tracking-wide cursor-pointer hover:bg-white hover:bg-opacity-30  py-4 transition-all duration-500">Chats</h1></Link>
