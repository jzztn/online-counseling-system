...
const SideBar = () => {
	return (
		<div className="grid grid-cols-[auto,1fr]">
			<div className="hidden h-full bg-gradient-to-b from-lightgreen to-sideBar grid grid-rows-[1fr,auto] py-8 px-16 lg:block group-hover:block transition-all duration-700">
				<ul className=" flex flex-col gap-6">
					<div className="group">
						<Link href={'/student/profile'}><li className="cursor-pointer">Edit Profile</li></Link>
						<div className="bg-white w-0 h-1 opacity-0 transition-all duration-500 group-hover:opacity-100 group-hover:w-full"></div>
					</div>

					<div className="group">
						<Link href={'/student/appointment'}><li className="cursor-pointer">Session Appointments</li></Link>
						<div className="bg-white w-0 h-1 opacity-0 transition-all duration-500 group-hover:opacity-100 group-hover:w-full"></div>
					</div>

					<div className="group">
						<Link href={'/student/chat'}><li className="cursor-pointer">Chat</li></Link>
						<div className="bg-white w-0 h-1 opacity-0 transition-all duration-500 group-hover:opacity-100 group-hover:w-full"></div>
					</div>
				</ul>

				<Link href={"/"}><div className="text-md cursor-pointer">Log Out</div></Link>

			</div>

			<div className="group lg:hidden ml-auto z-10">
				<MenuAlt2Icon className="h-8 w-8 text-button m-6" />
